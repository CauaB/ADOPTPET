    ...
    <div class="container">
        <div class="row">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $sql = "UPDATE pet SET nome = '$nome', sexo = '$sexo', datanasc = '$datanasc', CODabrig = '$abrigo', raca = '$raca', especie = '$especie' WHERE CODpet = '$codpet'";

                // Executar a consulta
                if (mysqli_query($conn, $sql)) {
                    mensagem("$nome alterado com sucesso!", 'success');
                } else {
                    mensagem("Erro! Não alterado!", 'danger');
                }
            }
            ?>
